/*
	OLED_SSD1332 - An Hardware Accellerated and CPU optimized library for drive
    ...
    OLED_SSD1332 Library is free software: you can redistribute it and/or modify
    it under the terms of the GNU General Public License as published by
    the Free Software Foundation, either version 3 of the License, or
    (at your option) any later version.

    OLED_SSD1332 Library is distributed in the hope that it will be useful,
...
// the class
class OLED_SSD1332 : public Adafruit_GFX {
 public:
	//4 or 5 wire configuration
	OLED_SSD1332(uint8_t CS, uint8_t RS, uint8_t RST);
	OLED_SSD1332(uint8_t CS, uint8_t RS);
	void begin(void);
